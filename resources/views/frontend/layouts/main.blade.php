...
<html lang="en">
    <head>
        ...
        <link
            href="{{ asset('frontend/lib/owlcarousel/assets/owl.carousel.min.css') }}"
            rel="stylesheet"
        />
                ...
                >
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav ms-auto">
                            <a href="/" class="nav-item nav-link {{ ($title == "Home")?'active':'' }}" 
                                >Home</a
                            >
                            <a href="/profil" class="nav-item nav-link {{ ($title == "Profil")?'active':'' }}">Profil</a>
                            <a href="/potensi" class="nav-item nav-link {{ ($title == "Potensi")?'active':'' }}">Potensi</a>
                ...
                <div class="row g-5">
                    <div class="col-lg-4 col-md-6">
                        <div class="text-center mb-4">
                            <img
                                src="{{ asset('frontend/img/lambangdesa.png') }}"
                                alt="logo desa candikuning"
                                style="width: 80px"
                            />
                        </div>
