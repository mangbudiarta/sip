    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-lg-12 mb-4 order-0">
                <div class="row">
                    <div class="col-xxl">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Berita/</span> Kategori</h4>
                        <div class="card mb-4">
    ...
    <script>
        $(function() {
            ...
            $("#add_kategori_form").submit(function(e) {
                ...
                $.ajax({
                    // panggil route name save.kategoriberita
                    url: '{{ route('save.kategoriberita') }}',
            ...
            $(document).on('click', '.deletekategori', function(e) {
                ...
                if (confirm('Yakin hapus data ini ?')) {
                    $.ajax({
                        // panggil route name delete.kategoriberita
                        url: '{{ route('delete.kategoriberita') }}',
                        // method DELETE
                        method: 'DELETE',
            ...
            $(document).on('click', '.editkategori', function(e) {
                ...
                let id = $(this).attr('id');
                $.ajax({
                    // panggil route name edit.kategoriberita
                    url: '{{ route('edit.kategoriberita') }}',
                    // method GET
                    method: 'GET',
                    // isi data : id_kategori dan token
                    data: {
            ...
            $("#edit_kategori_form").submit(function(e) {
                ...
                $.ajax({
                    // panggil route name update.kategoriberita
                    url: '{{ route('update.kategoriberita') }}',
                    // method POST
                    method: 'POST',
                    // isi data: obyek dataForm
                    data: dataForm,
            ...
            function fetch(type = '', message = '') {
                $.ajax({
                    // panggil route name fetch.kategoriberita
                    url: '{{ route('fetch.kategoriberita') }}',
                    // method GET
                    method: 'GET',
                    success: function(response) {
