                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <div id="img-previewdetail" class="my-2 d-flex justify-content-center" alt="">
                                        </div>
                                        <div class="mb-3">
                                            <label class="col-form-label" for="judul">Judul</label>
                                            <input type="text" class="form-control" id="juduldetail" name="judul"
                                                placeholder="ex : Desa Wisata & Indah" readonly />
                                        </div>
                                        <div class="mb-3">
                                            <label class="col-form-label" for="deskripsi">Deskripsi</label>
                                        ...
                                        <div class="mb-3">
                                            <label class="col-form-label" for="video">Link Video Youtube</label>
                                            <input type="text" class="form-control" id="videodetail" name="video"
                                                placeholder="ex : https://youtu.be/Un4Iraqqqqs" readonly />
                                        </div>
                                        <div class="row justify-content-end">
                                            <div class="col-sm-12">
                                                <button type="button" class="btn btn-outline-secondary"
