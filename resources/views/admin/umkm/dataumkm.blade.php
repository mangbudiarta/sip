    ...
    <tbody>
        @forelse ($umkm as $item)
            <tr>
                ...
                <td>{{ $item->namaumkm }}</td>
                <td><img src="/storage/umkm_img/{{ $item->gambarcover }}" alt="Gambar UMKM" width="100"
                ...
                <a href="#" id='{{ $item->id_umkm }}' class="btn btn-info btn-sm detailUmkm"
                    ...
                    <a href="" id='{{ $item->id_umkm }}' class="btn btn-info btn-sm"><i
                        class="menu-icon tf-icons bx bx-show m-0"></i></a>
                    <a href="/admin/umkmgambar/{{ $item->id_umkm}}" id='{{ $item->id_umkm }}' class="btn btn-success btn-sm"><i
                        class="menu-icon tf-icons bx bx-image m-0"></i></a>
                    <a href="#" id='{{ $item->id_umkm }}' class="btn btn-warning btn-sm editumkm" data-bs-toggle="modal"
