                        ...
                        <div class="mb-3">
                            <label class="col-form-label" for="video">Link Video Youtube</label>
                              <input
                                ...
                                id="video"
                                name="video"
                                placeholder="ex : https://youtu.be/Un4Iraqqqqs"
                              />
                        </div>
                        <div>
                            <label for="formFile" class="form-label">Gambar Cover<span class=" text-muted">(png/jpg)</span></label>
                            <input type="file" class="form-control" type="file" id="formFile" name="gambarcover" onchange="handleFiles(event)"/>
                        ...
                        <table class="datatables table border-top">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>https://youtu.be/Un4Iraqqqqs</td>
                              <td>gambar.jpg</td>
                              <td>
                                <a href="/#about" class="btn btn-info btn-sm"><i class="menu-icon tf-icons bx bx-show m-0"></i></a>
                              </td>
                            </tr>
                          </tbody>
                        </table>
