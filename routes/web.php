...
Route::group(['prefix' => 'admin'], function () {
    //Login Petugas
    Route::get('/loginpetugas', [AuthPetugasController::class, 'index'])->name('loginpetugas');
    Route::post('/loginpetugas', [AuthPetugasController::class, 'login']);
    Route::get('/logoutpetugas', [AuthPetugasController::class, 'logout'])->name('logoutpetugas');
    ...
    Route::middleware(['petugas'])->group(function () {
        ...
        Route::get('profildesa', [ProfildesaController::class, 'index'])->name('profildesa')->middleware('petugas');
